...
export default function AdminLayout({ children, title, actions }: AdminLayoutProps) {
    ...
    const navItems = [
        ...
        { icon: Layout, label: 'Slides Library', path: '/admin/slides' },
        { icon: Settings, label: 'Settings', path: '/admin/settings' },
    ];

    // Add Team Management for Super Admins
    if (role === 'super_admin') {
        // We might want to add a dedicated team route or just keep it in settings/dashboard
        // For now, let's assume it's accessible via settings or a new route if needed.
        // Adding it here as an example if we had a route.
    }
